...
var TableTriggers = (function (EventEmitter) {
  function TableTriggers(conn, channel) {
    var _this = this;
    _classCallCheck(this, TableTriggers);
  ...
  _inherits(TableTriggers, EventEmitter);

  _prototypeProperties(TableTriggers, null, {
    createTrigger: {
