...
module.exports = exports = {
  ...
  */
	getDiffFromSupplied: function getDiffFromSupplied(client, notifications, parsed, params) {
		var allRows;
	...
	flattenNotifications: function flattenNotifications(notifications) {
		var out = [];
		var pushItem = function (payload, key) {
			var data = _.clone(payload[key]);
			data._op = payload.op;
			data._key = key;
